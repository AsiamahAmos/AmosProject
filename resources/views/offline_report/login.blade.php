...
<body style="font-family:candara;font-weight:bold" class="animsition">
  <div class="page-wrapper">
     <header style="left:0px;opacity:0" class="header-desktop d-none d-lg-block">
            <div class="section__content section__content--p70">
              <div class="header3-wrap">
                <div class="logo">
                    <a href="#">
                    <img style="height:75px;width:400px" src="{{ asset('images/reports_image/icon/offline-logo-blue.png') }}" alt="" />
                     </a>
                   </div>
                </div>
            </div>
            ...
            <div style="width:100%" class="main-content col-md-12">
                <div style="width:100%" class="section__content section__content--p70">
                    ...
                    <div class="col-lg-6" style="margin-left:200px;">
                                <div style="background-image:url('{{ url('images/reports_image/icon/.jpg') }}');opacity:0.99" class="card">
                                    <div style="color:#17a2b8;text-align:center" class="card-header"><h2 style="color:#17a2b8">Offline Report Viewer</h2></div>
                                    <div class="card-body card-block">
                                        <form action="{{ url('/login') }}" method="post" class="">{{ csrf_field() }}
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" id="username" name="username" placeholder="Username" class="form-control" required="required">
                                                    <div class="input-group-addon"><img style="height:20px;width:20px" src="{{ asset('images/reports_image/icon/user4.png') }}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <img style="height:20px;width:20px" src="{{ asset('images/reports_image/icon/password2.png') }}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-actions form-group">
                                                <button style="margin-left:140px" type="submit" class="btn btn-primary btn-sm">Let's Go</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
$("#container").attr("style","background-color:#eee;background-image:url('{{ url('images/reports_image/icon/banner.jpg') }}');background-repeat:no-repeat;background-size: 100% 100%");
