            ...
            <div class="section__content section__content--p70">
              <div class="header3-wrap">
                <div class="logo">
                    ...
                    <!-- <img style="height:75px;width:500px;margin-left:350px;margin-top:-5px;opacity:0" src="{{ asset('images/reports_image/icon/offline-logo-blue.png') }}" alt="" /> -->
                    <font  color="#003875" style="height:75px;max-width:1000px;margin-left:320px;margin-top:-5px;opacity:1;font-size:50px;font-family:Poppins,sans-serif">Offline Report Viewer</font>
                    </a>
                </div>
                <div style="float:right;margin-top:25px">
                <button class="btn btn-default btn-sm" onclick="$.fn.idleTimeout().logout();"><h5>  <a style="text-size:13px;color:#003875" href="{{ url('/logout') }}"><img style="height:15px;width:15px" src="{{ asset('images/reports_image/icon/logout.png') }}"/>&nbsp;Logout</a></h5></button>
                </div> 
              </div>
            </div> 
        </header>
                ...
                <div id="table-container" style="border:3px solid #17a2b8;padding-top:15px;border-radius:10px;background:#17a2b8">
                   <div id="search-items" style="background:linear-gradient(to top,#17a2b8 10%,#17a2b8 90%);padding:0px;border-radius:20px;">
                      ...
                      <div class="d_name_filter">
                         <h4> <span class="badge badge-primary"></span>
                        ...
                        <div id="baseDateControl">
                           <div class="dateControlBlock">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                   ...
                                   <div class="b_name_filter" style="margin-left:370px;margin-top:-60px;width:100%">
                                    <h4><span class="badge badge-primary" for="min"></span>
...
$(".dateControlBlock").attr("style","margin-top:-35px;");
...
<link href="{{ asset('css/reports_css/jquery-ui.css') }}" rel="stylesheet" media="all">
...
<script type="text/javascript" src="{{ asset('js/reports_js/jquery1.11.2.min.js') }}"></script>
<!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js" type="text/javascript"></script> -->

<script type="text/javascript" src="{{ asset('js/reports_js/jquery-ui1.11.3.min.js') }}"></script>
...
<script type="text/javascript" charset="utf-8">
   ...
   jQuery(document).ready(function ( $ ){
    jQuery(document).idleTimeout({
      redirectUrl: "{{ url('/logout') }}",      // redirect to this url on logout. Set to "redirectUrl: false" to disable redirect
 
      // idle settings
      idleTimeLimit: 5,           // 'No activity' time limit in seconds. 1200 = 20 Minutes
